...
def lookup_node_mapping(node_type, node_mappings):
...
def map_nodes(topology, node_mappings):
    ...
    for node_id, node in topology.nodes.items():
        ...
        mapping = lookup_node_mapping(node_type, node_mappings)
        if mapping is not None:
            ...
            node.gns3_template_id = mapping.get("template_id")
